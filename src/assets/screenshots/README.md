...
These are the real-UI slots used by drafta.org. The PNGs go to `public/screenshots/` (served at `/screenshots/`); this note stays out of the build. **The PNGs are not
...
<figure class="shot">
  <div class="shot__frame">
    <img class="shot__img" src="/screenshots/editor.png"

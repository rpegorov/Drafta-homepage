...
export const ru: Messages = {
  ...
  checkoutInkH2: 'Оплата картой пока не подключена.',
  ...
  checkoutFaqA2: '30 дней начинаются с момента регистрации и не требуют карты. После них приложение работает только на чтение, пока на аккаунте нет тарифа: заметки по-прежнему читаются, а создание, правка и экспорт требуют тарифа, выбранного на этой странице.',

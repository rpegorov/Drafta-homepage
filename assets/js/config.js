...
window.DRAFTA = {
  ...
  /* Offline render path only — the monthly and yearly options of the one plan.
     ...
     billing options and its current quota (30 GB / unlimited notes, measured
     2026-09-23). There is deliberately no lifetime entry: the product no longer
     sells one, so the offline path must not advertise it. Whenever the API's
     codes, prices or quotas change, this file changes with them. */
  planFallback: [
